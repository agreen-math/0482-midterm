...
\uplevel{\textbf{For Problems \ref{oper-start} through \ref{oper-end}, perform the operations and simplify.  Assume all variables are positive and rationalize the denominator when appropriate.}}

\question[5]\label{oper-start} $\sqrt{150xy^2}-2\sqrt{18x^3}+y\sqrt{24x}+x\sqrt{128x}$
\vspace*{\stretch{1}}\answerline
...
\question[5]\label{oper-end} $(81x^4y^2)^{-\frac{1}{2}}$
\vspace*{\stretch{1}}\answerline
