...
def main():
    parser = argparse.ArgumentParser(description="CheckIt to Department LaTeX Parser - Web Final (18pt)")
    ...
    # Apply exact page breaks (1 question per page for the 18pt format)
    for idx in range(19):
    ...
    print(f"Successfully parsed and built 18pt exam. Output saved to {args.out}")
