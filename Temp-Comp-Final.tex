...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\course}{MATH 0482 (Revised SP26)}
...
\uplevel{\textbf{For Problems \ref{func-start} and \ref{func-end}, identify the domain and range and determine whether or not the graph represents a function.  if it is not a function, explain why.}}
...
\uplevel{\textbf{For Problems \ref{rad-simp-begin} through \ref{rad-simp-end}, perform the operations and simplify.  Assume all variables are positive and rationalize the denominator when appropriate.}}
